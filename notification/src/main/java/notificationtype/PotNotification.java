 ...
 * @author estudiantes
 */
public class PotNotification extends NotificationType{
    
    public PotNotification(IAdNotificationBehavior adNotificationBehaviorParam, ITransferNotificationBehavior transferNotificationBehaviorParam, IPotNotificationBehavior potNotificationBehaviorParam) {
