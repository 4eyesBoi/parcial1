 ...
 * @author estudiantes
 */
public class AdNotification extends NotificationType{
    
    public AdNotification(IAdNotificationBehavior adNotificationBehaviorParam, ITransferNotificationBehavior transferNotificationBehaviorParam, IPotNotificationBehavior potNotificationBehaviorParam) {
